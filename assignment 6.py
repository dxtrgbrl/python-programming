...
cursor = db.cursor()
cursor.execute("INSERT INTO users VALUES (NULL, '" + outputColor + "');")
cursor.close()
...
cursor = db.cursor()
cursor.execute("SELECT * FROM survey WHERE choice = '1 - Black'")
...
cursor = db.cursor()
cursor.execute("SELECT * FROM survey WHERE choice = '2 - White'")
rows = cursor.fetchall()
...
cursor = db.cursor()
cursor.execute("SELECT * FROM survey WHERE choice = '3 - Red'")
rows = cursor.fetchall()
...
cursor = db.cursor()
cursor.execute("SELECT * FROM survey WHERE choice = '4 - Blue'")
rows = cursor.fetchall()
...
cursor = db.cursor()
cursor.execute("SELECT * FROM survey WHERE choice = '5 - Green'")
rows = cursor.fetchall()
